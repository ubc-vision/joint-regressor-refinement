...
class Transformer_Refiner(nn.Module):
    ...
    def __init__(self):
        super(Transformer_Refiner, self).__init__()

        self.num_features = 512
        self.num_joints = 17
        self.num_vertices = 431
        self.num_feats_per_vert = 128
        ...
        self.linears = nn.Sequential(
            ...
            Residual_Block(self.num_features),
            nn.Linear(self.num_features, self.num_vertices*self.num_feats_per_vert)
        )
    ...
    def forward(self, batch):
        ...
        output = output.reshape(-1, self.num_vertices, self.num_feats_per_vert)/10

        output += batch["final_layer"]
